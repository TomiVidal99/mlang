...
export const ERROR_CODES = {
  ...
  UNDEFINED_TOKEN: 55,
  TOO_MANY_NL: 60,
  CELL_ARR_BAD_ARGS: 140,
  CELL_ARR_BAD_COMMA: 141,
  CELL_ARR_BAD_MISSING_END: 142,
  CELL_ARR_ACCESS_MISSING_END: 160,
  CELL_ARR_ACCESS_BAD_ARGS: 161,
  MISSING_PATH: 200,
  TOO_MANY_ARGS: 201,
  ...
  MISSING_EQUALS_STMNT: 4004,
  MISSING_EQUALS_FOR_LOOP: 4005,
  MISSING_END_KEYWORD_FOR_LOOP: 4006,
  MISSING_END_RPAREN_FOR_LOOP: 4007,
  WRONG_DATA_TYPE_FOR_LOOP: 5001,
